__all__ = [
    ...
    'PercolationsGenerationModeBroadcast',
    'PercolationsGenerationModeRDD']
...
"""
PercolationsGenerationModeBroadcast = 0
"""
Indicate that the mesh percolations will be generated by a broadcast variable
...
"""
PercolationsGenerationModeRDD = 1
"""
Indicate that the mesh percolations will be generated by a RDD containing the edges that are broken.
Suitable for meshes that their corresponding data do not fit in the cache provided by Spark. Also,
with this mode, a left join is performed, making it not the best mode.
"""
