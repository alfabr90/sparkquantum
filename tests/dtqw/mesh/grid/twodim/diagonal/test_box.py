...
from sparkquantum.dtqw.mesh.grid.twodim.diagonal.box import Box
...
class TestBox(Base):
    ...
    def test_str(self):
        self.assertEqual(str(self.mesh),
                         'Diagonal box with shape {}'.format(self.mesh.shape))
        self.assertEqual(str(self.mesh_perc),
                         'Diagonal box with shape {} and {}'.format(self.mesh_perc.shape,
