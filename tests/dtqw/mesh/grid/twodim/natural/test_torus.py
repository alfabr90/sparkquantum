...
from sparkquantum.dtqw.mesh.grid.twodim.natural.torus import Torus
...
class TestTorus(Base):
    ...
    def test_str(self):
        self.assertEqual(str(self.mesh),
                         'Natural torus with shape {}'.format(self.mesh.shape))
        self.assertEqual(str(self.mesh_perc),
                         'Natural torus with shape {} and {}'.format(self.mesh_perc.shape,
