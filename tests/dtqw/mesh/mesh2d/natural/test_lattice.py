...
from sparkquantum.dtqw.mesh.mesh2d.natural.lattice import Lattice
...
class TestLattice(Base):
    ...
    def test_str(self):
        self.assertEqual(str(self.mesh),
                         'Natural Lattice with dimension {}'.format(self.mesh.size))
        self.assertEqual(str(self.mesh_bl),
                         'Natural Lattice with dimension {} and {}'.format(self.mesh_bl.size,
