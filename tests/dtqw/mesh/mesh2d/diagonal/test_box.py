...
from sparkquantum.dtqw.mesh.mesh2d.diagonal.box import Box
...
class TestBox(Base):
    ...
    def test_str(self):
        self.assertEqual(str(self.mesh),
                         'Diagonal Box with dimension {}'.format(self.mesh.size))
        self.assertEqual(str(self.mesh_bl),
                         'Diagonal Box with dimension {} and {}'.format(self.mesh_bl.size,
