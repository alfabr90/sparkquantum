...
from sparkquantum.dtqw.mesh.mesh2d.diagonal.torus import Torus
...
class TestTorus(Base):
    ...
    def test_str(self):
        self.assertEqual(str(self.mesh),
                         'Diagonal Torus with dimension {}'.format(self.mesh.size))
        self.assertEqual(str(self.mesh_bl),
                         'Diagonal Torus with dimension {} and {}'.format(self.mesh_bl.size,
